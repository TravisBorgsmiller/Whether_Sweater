class Api::V1::FoodieController < ApplicationController
  ...
  def show
    ...
    # restaurant_response = Faraday.get("https://developers.zomato.com/api/v2.1/search?entity_id=#{entity_info[:location][:entity_id]}&entity_type=subzone&cuisines=55") do |faraday|
    #   faraday.headers['user-key'] = ENV['ZOMATO_API_KEY']
    # end
